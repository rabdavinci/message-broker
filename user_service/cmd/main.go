...
import (
	...
	"github.com/rabdavinci/message-broker/user_service/genproto/user_service"
	"github.com/rabdavinci/message-broker/user_service/pkg/logger"
	"github.com/rabdavinci/message-broker/user_service/service"
...
func main() {
	...
	userService := service.NewUserService(db, log, client)
