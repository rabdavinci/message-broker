...
func Load() Config {
	...
	c.BrokerServiceHost = cast.ToString(getOrReturnDefault("BROKER_SERVICE_HOST", "localhost"))
	c.BrokerServicePort = cast.ToInt(getOrReturnDefault("BROKER_SERVICE_PORT", 5004))

	c.LogLevel = cast.ToString(getOrReturnDefault("LOG_LEVEL", "debug"))
	c.RPCPort = cast.ToString(getOrReturnDefault("RPC_PORT", ":5003"))
